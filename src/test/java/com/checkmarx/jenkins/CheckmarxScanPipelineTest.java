...
public class CheckmarxScanPipelineTest extends CheckmarxTestBase {
    ...
    public void doSuccessCheckmarxPipelineScan() throws Exception {
        ...
        project.setDefinition(new CpsFlowDefinition("" +
                ...
                "  checkmarxASTScanner additionalOptions: '--scan-types sast', useOwnServerCredentials: true, baseAuthUrl: '" + this.astBaseAuthUrl + "', checkmarxInstallation: '" + Constants.JT_LATEST + "', credentialsId: '" + Constants.JT_TOKEN_ID + "', projectName: 'successIntegrationJenkinsScan', serverUrl: '" + this.astServerUrl + "', tenantName: '" +
                "}", true));
